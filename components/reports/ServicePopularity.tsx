...
export default function ServicePopularity({ data, insight }: ServicePopularityProps) {
  return (
    <div className="mb-8 grid min-w-0 gap-6 xl:grid-cols-3">
      <div className="min-w-0 rounded-lg border border-gray-200 bg-white p-4 sm:p-6 xl:col-span-2">
      ...
      {insight && (
        <div className="min-w-0 rounded-lg border border-blue-200 bg-blue-50 p-4 sm:p-6">
